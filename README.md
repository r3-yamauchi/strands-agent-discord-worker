...
[とすりさん作のハンズオン手順](https://zenn.dev/tosuri13/books/0de24e94fb551f) の
[中で作成したもの](https://zenn.dev/tosuri13/books/0de24e94fb551f/viewer/6f4440)
を使用してください。

# 2. Lambda関数をサブスクライブ
aws sns subscribe \
  --topic-arn arn:aws:sns:<REGION>:<ACCOUNT_ID>:ai-discord-chatbot-topic \
  --protocol lambda \
...
- [とすりさん作の Amazon BedrockとAWS SAMで作るDiscord AIチャットボット ハンズオン手順](https://zenn.dev/tosuri13/books/0de24e94fb551f)
